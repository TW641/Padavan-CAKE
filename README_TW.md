...
* **🇹🇼🤝🇯🇵 來自日本的頂尖網路學者的跨國關注：**
    ...
    <a href="images/followers.png" target="_blank"><img style="max-width: 100%; height: auto; border: 1px solid #ccc; border-radius: 8px;" src="images/followers.png" alt="GitHub 大神追蹤證明"></a>
...
* **🇹🇼 總統級的數位國民外交：**
    ...
    <a href="images/Facebook.png" target="_blank"><img style="max-width: 100%; height: auto; margin-bottom: 10px; border: 1px solid #ccc; border-radius: 8px;" src="images/Facebook.png" alt="LibreQoS Facebook 貼文"></a>
    <a href="images/X.png" target="_blank"><img style="max-width: 100%; height: auto; margin-bottom: 10px; border: 1px solid #ccc; border-radius: 8px;" src="images/X.png" alt="LibreQoS X 貼文"></a>
    <a href="images/LinkedIn.png" target="_blank"><img style="max-width: 100%; height: auto; border: 1px solid #ccc; border-radius: 8px;" src="images/LinkedIn.png" alt="LibreQoS LinkedIn 貼文"></a>
...
<a href="images/CAKE.png" target="_blank"><img style="max-width: 100%; height: auto; border: 1px solid #ccc; border-radius: 8px;" src="images/CAKE.png" alt="CAKE 原理圖"></a>
...
<a href="images/VerifyCAKE1.png" target="_blank"><img style="max-width: 100%; height: auto; margin-bottom: 5px; border: 1px solid #ccc; border-radius: 8px;" src="images/VerifyCAKE1.png" alt="圖1"></a>
<a href="images/VerifyCAKE2.png" target="_blank"><img style="max-width: 100%; height: auto; margin-bottom: 5px; border: 1px solid #ccc; border-radius: 8px;" src="images/VerifyCAKE2.png" alt="圖2"></a>
<a href="images/VerifyCAKE3.png" target="_blank"><img style="max-width: 100%; height: auto; margin-bottom: 5px; border: 1px solid #ccc; border-radius: 8px;" src="images/VerifyCAKE3.png" alt="圖3"></a>
<a href="images/VerifyCAKE4.png" target="_blank"><img style="max-width: 100%; height: auto; border: 1px solid #ccc; border-radius: 8px;" src="images/VerifyCAKE4.png" alt="圖4"></a>
